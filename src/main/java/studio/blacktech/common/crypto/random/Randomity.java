package studio.blacktech.common.crypto.random;
...
public class Randomity {
    ...
    public static String hashMD5R4() {
        byte[] input = hashHex();
        String temp1 = Digester.MD5(input);
        String temp2 = Digester.MD5(temp1.getBytes());
        String temp3 = Digester.MD5(temp2.getBytes());
        return Digester.MD5(temp3.getBytes());
    }
    ...
    public static String hashMD5S4() {
        String hash1 = Digester.md5(hashHex());
        String hash2 = Digester.md5(hashHex());
        String hash3 = Digester.md5(hashHex());
        String hash4 = Digester.md5(hashHex());
        return Digester.MD5((hash1 + hash2 + hash3 + hash4).getBytes());
    }
