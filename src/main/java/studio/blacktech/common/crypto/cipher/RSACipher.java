...
public class RSACipher {
    ...
    public String getEncodedPublicKey() {
        if (publicKey == null) throw new IllegalArgumentException("Instance has no public key");
    ...
    public String getEncodedPrivateKey() {
        if (privateKey == null) throw new IllegalArgumentException("Instance has no private key");
